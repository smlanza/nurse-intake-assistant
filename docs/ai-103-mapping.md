...
contract through an injected fake client in offline tests. The backend owns side
effects such as persistence, notifications, and review state; the AI provider
should only return structured reasoning output.
