...
contract through an injected fake client in offline tests, and a live adapter
scaffold now matches the same seam for a future manual SDK smoke test. The
