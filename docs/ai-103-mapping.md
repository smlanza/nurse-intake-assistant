...
- The standalone Application Insights ingestion proof is implemented and
  offline-tested; READY identity handoff is private and fail-closed, while fresh
  compatible READY evidence and live or App Service-hosted telemetry remain unproven
