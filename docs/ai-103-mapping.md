...
1. Azure Speech transcription service boundary
...
boundary. Keep it mock-first, human-reviewed, and separate from live deployment,
voice automation, or production clinical claims.
```
