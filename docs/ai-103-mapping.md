...
- Live deployment and verification of the offline Key Vault/RBAC boundaries
...
2. Key Vault: deploy and verify the offline-represented infrastructure and least-privilege authorization
