...
1. submit a text intake from the Text Intake panel.
...
2. Click Load Recent Cases.
   ...
   - confirm recent cases refresh and include the newly created case.
3. Click Load Queue Summary.
   - Expected: `GET /cases/summary` returns 200.
   - Confirm summary counts reflect the current demo cases.
4. Select or copy a case id from Recent Cases.
